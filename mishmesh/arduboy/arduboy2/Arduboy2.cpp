...
#else // [mishmesh] portable C equivalent of the AVR asm above (per the #if 0 block below)
  bit = 1 << (y & 7);
...
#else // [mishmesh] portable C equivalent of the AVR asm above (the "C version:" comment)
  if (color != BLACK)
  {
    color = 0xFF; // all pixels on
  }
