...
inline bool& reducedMotionFlag() { static bool v = false; return v; }
inline bool reducedMotion() { return reducedMotionFlag(); }
inline void setReducedMotion(bool on) { reducedMotionFlag() = on; }
